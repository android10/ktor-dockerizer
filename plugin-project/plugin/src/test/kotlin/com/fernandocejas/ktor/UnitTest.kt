...
/**
 * Base class for Unit tests. Inherit from it to create test cases in isolation where
 * all the collaborators of the subject under test are dummy/mock objects.
 */
